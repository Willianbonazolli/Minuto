...
}`,instructions:["Leia um valor com `prompt`.","Use uma condicao para decidir a resposta.","Mostre o resultado final no console."]}]}];function v(a){return a==="Easy"?"text-[#9fcfc0]":a==="Hard"?"text-[#d79486]":"text-[#d7ba83]"}function x(a){return a==="done"?"Concluída":a==="locked"?"Bloqueada":"Disponível"}function b(a){return a==="done"?"border border-emerald-400/35 bg-emerald-500/12 text-emerald-300":a==="locked"?"border border-rose-400/30 bg-rose-500/12 text-rose-300":"border border-amber-300/35 bg-amber-400/12 text-amber-200"}function N(a,d){if(/^\s*<!DOCTYPE/i.test(a)){const p=a.match(/^(\s*)(<!DOCTYPE)(\s+)(html)(>)$/i);return p?e.jsxs("span",{children:[e.jsx("span",{className:"text-[#e9ddcf]",children:p[1]}),e.jsx("span",{className:"text-[#c586c0]",children:p[2]}),e.jsx("span",{className:"text-[#e9ddcf]",children:p[3]}),e.jsx("span",{className:"text-[#4ec9b0]",children:p[4]}),e.jsx("span",{className:"text-[#808080]",children:p[5]})]},d):e.jsx("span",{className:"text-[#9cdcfe]",children:a},d)}const i=a.match(/^\s*/)?.[0]||"",n=a.trim(),l=n.startsWith("</"),c=n.endsWith("/>"),t=n.match(/^<\/?([^\s/>]+)(.*?)(\/?)>$/);if(!t)return e.jsx("span",{className:"text-[#9cdcfe]",children:a},d);const[,m,o,r]=t,f=[],s=/([:@\w-]+)(=)("[^"]*"|'[^']*')?/g;let u;for(;(u=s.exec(o))!==null;)f.push({name:u[1],equal:u[2]||"",value:u[3]||""});return e.jsxs("span",{children:[e.jsx("span",{className:"text-[#e9ddcf]",children:i}),e.jsx("span",{className:"text-[#808080]",children:l?"</":"<"}),e.jsx("span",{className:"text-[#569cd6]",children:m}),f.map((p,g)=>e.jsxs("span",{children:[e.jsx("span",{className:"text-[#e9ddcf]",children:" "}),e.jsx("span",{className:"text-[#9cdcfe]",children:p.name}),e.jsx("span",{className:"text-[#d4d4d4]",children:p.equal}),e.jsx("span",{className:"text-[#ce9178]",children:p.value})]},`${d}-attr-${g}`)),c||r?e.jsx("span",{className:"text-[#808080]",children:" /"}):null,e.jsx("span",{className:"text-[#808080]",children:">"})]},d)}function C(a){const d=a.split(`
`);return e.jsx("code",{className:"block",children:d.map((i,n)=>{const l=i.trim(),c=i.match(/^\s*/)?.[0]||"";if(!l)return e.jsx("div",{className:"whitespace-pre",children:i},`${n}-empty`);if(l.endsWith("{")){const m=l.slice(0,-1).trim();return e.jsxs("div",{className:"whitespace-pre",children:[e.jsx("span",{className:"text-[#e9ddcf]",children:c}),e.jsx("span",{className:"text-[#d7ba83]",children:m}),e.jsxs("span",{className:"text-[#808080]",children:[" ","{"]})]},`${n}-${i}`)}if(l==="}")return e.jsxs("div",{className:"whitespace-pre",children:[e.jsx("span",{className:"text-[#e9ddcf]",children:c}),e.jsx("span",{className:"text-[#808080]",children:"}"})]},`${n}-${i}`);const t=l.match(/^([-\w]+)(:\s*)(.+?)(;?)$/);return t?e.jsxs("div",{className:"whitespace-pre",children:[e.jsx("span",{className:"text-[#e9ddcf]",children:c}),e.jsx("span",{className:"text-[#9cdcfe]",children:t[1]}),e.jsx("span",{className:"text-[#d4d4d4]",children:t[2]}),e.jsx("span",{className:"text-[#ce9178]",children:t[3]}),e.jsx("span",{className:"text-[#808080]",children:t[4]})]},`${n}-${i}`):e.jsx("div",{className:"whitespace-pre text-[#e9ddcf]",children:i},`${n}-${i}`)})})}function q(a){const d=a.split(`
`);return e.jsx("code",{className:"block",children:d.map((i,n)=>{const l=i.split(/("(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g);return e.jsx("div",{className:"whitespace-pre",children:l.map((c,t)=>c?/^("(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')$/.test(c)?e.jsx("span",{className:"text-[#ce9178]",children:c},`${t}-${c}`):c.split(/\b(const|let|if|else|true|false|prompt|console)\b/g).map((o,r)=>o?/^(const|let|if|else|true|false)$/.test(o)?e.jsx("span",{className:"text-[#c586c0]",children:o},`${t}-${r}-${o}`):/^(prompt|console)$/.test(o)?e.jsx("span",{className:"text-[#4ec9b0]",children:o},`${t}-${r}-${o}`):o.split(/(\b\d+\b)/g).map((s,u)=>s?/^\d+$/.test(s)?e.jsx("span",{className:"text-[#b5cea8]",children:s},`${t}-${r}-${u}-${s}`):e.jsx("span",{className:"text-[#e9ddcf]",children:s},`${t}-${r}-${u}-${s}`):null):null):null)},`${n}-${i}`)})})}function M(a,d){if(d==="css")return C(a);if(d==="javascript")return q(a);const i=a.split(`
`);return e.jsx("code",{className:"block",children:i.map((n,l)=>{const c=n.split(/(<\/?[^>]+>)/g);return e.jsx("div",{className:"whitespace-pre",children:c.map((t,m)=>/^\s*<!DOCTYPE/i.test(t)||/^(\s*)<\/?[^>]+>$/.test(t)?N(t,`${m}-${t}`):e.jsx("span",{className:"text-[#e9ddcf]",children:t},`${m}-${t}`))},`${l}-${n}`)})})}function T(a){return a==="css"?"style.css":a==="javascript"?"script.js":"index.html"}function E({user:a,progressVersion:d,onStartActivity:i}){const[n,l]=h.useState("html"),[c,t]=h.useState("html-1"),m=h.useMemo(()=>y(j,a),[d,a]),o=h.useMemo(()=>m.find(s=>s.id===n)||m[0],[n,m]),r=h.useMemo(()=>o.items.find(s=>s.id===c)||o.items[0],[o,c]),f=s=>{const u=m.find(p=>p.id===s);l(s),t(u?.items[0]?.id||"")};return e.jsxs("section",{className:"page-enter space-y-6",children:[e.jsxs("div",{className:"interactive-card surface-enter rounded-[2rem] border border-black/10 bg-[#221d19] px-6 py-6 text-[#f5efe6] shadow-[0_20px_60px_rgba(34,29,25,0.24)] sm:px-8",children:[e.jsxs("div",{className:"flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-xs uppercase tracking-[0.28em] text-[#c7b7a3]",children:"Roadmaps"}),e.jsx("h2",{className:"mt-3 text-3xl font-semibold sm:text-4xl",children:a?.name?`${a.name}, escolha sua trilha.`:"Escolha sua trilha."}),e.jsx("p",{className:"mt-3 max-w-3xl text-sm leading-6 text-[#d8ccbf]",children:"Desenvolva sua jornada de aprendizado por trilhas e avance passo a passo."})]}),e.jsx("div",{className:"rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-[#cdbdaa]",children:"3 trilhas disponíveis"})]}),e.jsx("div",{className:"mt-6 flex flex-wrap gap-3",children:m.map(s=>{const u=s.id===o.id;return e.jsx("button",{type:"button",onClick:()=>f(s.id),className:`glass-button rounded-full px-5 py-3 text-sm font-medium transition ${u?`bg-gradient-to-r ${s.accent} text-[#1e1915]`:"border border-white/10 bg-white/5 text-[#e4dacd] hover:bg-white/10"}`,children:s.label},s.id)})})]}),e.jsxs("div",{className:"grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_minmax(360px,0.8fr)]",children:[e.jsxs("div",{className:"interactive-card surface-enter surface-enter-delay-1 h-full rounded-[2rem] border border-black/10 bg-[#1d1916] p-3 shadow-[0_20px_60px_rgba(34,29,25,0.24)]",children:[e.jsx("div",{className:"rounded-[1.4rem] border border-white/5 bg-[#28221e] px-5 py-4 text-[#f5efe6]",children:e.jsxs("div",{className:"flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between",children:[e.jsxs("div",{children:[e.jsx("p",{className:`text-xs uppercase tracking-[0.22em] ${o.accentText}`,children:o.label}),e.jsx("h3",{className:"mt-1 text-2xl font-semibold",children:o.subtitle})]}),e.jsxs("div",{className:"text-sm text-[#b8aa99]",children:[o.items.length," atividades."]})]})}),e.jsx("div",{className:"mt-3 space-y-2",children:o.items.map(s=>{const u=s.id===r.id;return e.jsxs("button",{type:"button",onClick:()=>t(s.id),className:`interactive-row grid w-full grid-cols-2 gap-3 rounded-2xl px-4 py-4 text-left transition sm:grid-cols-[minmax(0,1fr)_90px_80px_100px] sm:items-center sm:px-5 ${u?"bg-[#332c27] text-[#fffaf2]":"bg-[#241f1b] text-[#e4dacd] hover:bg-[#2c2622]"}`,children:[e.jsx("div",{className:"col-span-2 min-w-0 sm:col-span-1",children:e.jsx("p",{className:"truncate text-base font-semibold",children:s.title})}),e.jsx("div",{className:"text-sm text-[#c2b09b] sm:text-right",children:s.acceptance}),e.jsx("div",{className:`text-sm font-semibold ${v(s.difficulty)} sm:text-left`,children:s.difficulty}),e.jsx("div",{className:"col-span-2 flex justify-start sm:col-span-1 sm:justify-end",children:e.jsx("span",{className:`rounded-full px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] ${b(s.status)}`,children:x(s.status)})})]},s.id)})})]}),e.jsxs("article",{className:"interactive-card surface-enter surface-enter-delay-2 flex min-h-[42rem] flex-col rounded-[2rem] border border-black/10 bg-[#231e1a] p-6 text-[#f5efe6] shadow-[0_20px_60px_rgba(34,29,25,0.24)]",children:[e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx("span",{className:`rounded-full bg-gradient-to-r ${o.accent} px-3 py-1 text-xs font-semibold text-[#1e1915]`,children:o.label}),e.jsx("span",{className:`rounded-full bg-white/5 px-3 py-1 text-xs font-semibold ${v(r.difficulty)}`,children:r.difficulty}),e.jsx("span",{className:`rounded-full px-3 py-1 text-xs font-semibold ${b(r.status)}`,children:x(r.status)})]}),e.jsx("div",{className:"mt-5 min-h-[5.5rem]",children:e.jsx("h3",{className:"text-3xl font-semibold leading-tight",children:r.title})}),e.jsxs("section",{className:"mt-3 min-h-[7rem]",children:[e.jsx("h4",{className:"text-lg font-semibold",children:"Resumo rápido"}),e.jsx("p",{className:"mt-3 text-sm leading-6 text-[#ddd1c5]",children:r.summary})]}),e.jsxs("section",{className:"mt-8 flex-1",children:[e.jsx("h4",{className:"text-lg font-semibold",children:"Preview"}),e.jsxs("div",{className:"code-shell mt-3 overflow-hidden rounded-2xl border border-white/5 bg-[#181411]",children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-white/5 bg-[#211b17] px-4 py-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"h-2.5 w-2.5 rounded-full bg-[#ff6f61]"}),e.jsx("span",{className:"h-2.5 w-2.5 rounded-full bg-[#f5c04f]"}),e.jsx("span",{className:"h-2.5 w-2.5 rounded-full bg-[#67c587]"})]}),e.jsx("span",{className:"text-xs font-medium tracking-[0.18em] text-[#bfae99]",children:T(o.id)})]}),e.jsx("pre",{className:"min-h-[18rem] overflow-auto p-4 text-sm leading-6 text-[#e9ddcf]",children:M(r.code,o.id)})]})]}),e.jsxs("div",{className:"mt-8 flex flex-wrap gap-3 pt-2",children:[e.jsx("button",{type:"button",className:`glass-button rounded-full px-5 py-3 text-sm font-semibold transition ${r.status==="locked"?"cursor-not-allowed bg-white/10 text-[#978877]":`bg-gradient-to-r ${o.accent} text-[#1e1915] hover:opacity-90`}`,disabled:r.status==="locked",onClick:()=>i?.(o,r),children:r.status==="done"?"Revisar atividade":r.status==="locked"?"Desbloqueie etapas anteriores.":"Começar atividade"}),e.jsxs("div",{className:"rounded-full border border-white/10 px-4 py-3 text-sm text-[#baa997]",children:["Taxa de acerto: ",r.acceptance,"."]})]})]})]})]})}export{E as default};
