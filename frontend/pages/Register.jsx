  ...
  return (
    <section className="grid gap-8 lg:grid-cols-[1fr_1.15fr]">
      <form onSubmit={handleSubmit} className="rounded-[2rem] border border-black/10 bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-sm text-black/55">Leva menos de um minuto para começar a estudar.</p>
      ...
      <div className="rounded-[2rem] bg-[#0e141b] p-8 text-white shadow-xl shadow-black/10">
        ...
        <p className="mt-4 max-w-lg text-white/70">
          Crie sua conta para começar a estudar, acompanhar sua evolução e continuar de onde parou.
        </p>
        <div className="mt-8 space-y-3">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/75">
            Cadastro simples com usuário, senha e confirmação de senha.
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/75">
            Trilha pensada para quem está dando os primeiros passos em programação.
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/75">
            Atividades curtas, exemplos visuais e progresso salvo automaticamente.
          </div>
        </div>
        <button
          type="button"
